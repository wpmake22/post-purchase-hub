 ...
 *
 * Override by copying this file to yourtheme/post-purchase-hub/emails/request-received.php.
 *
...
<p>
	<?php esc_html_e( "We received your request and a member of our team will get back to you. Here's what to expect:", 'post-purchase-hub' ); ?>
</p>
...
<p>
	...
	printf(
		...
		esc_html__( 'Expected response time: %s.', 'post-purchase-hub' ),
...
<p><?php esc_html_e( 'What you told us:', 'post-purchase-hub' ); ?></p>
<blockquote>
	<?php
