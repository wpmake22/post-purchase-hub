 ...
 *
 * Override by copying this file to yourtheme/post-purchase-hub/emails/plain/request-approved.php.
 *
...
echo esc_html__( 'Good news — we approved your request. Any change to your order is reflected below.', 'post-purchase-hub' ) . "\n\n";
