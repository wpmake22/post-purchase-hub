<?php
/**
 * Request approved email (plain text).
 *
 * Override by copying this file to yourtheme/wpmake-post-purchase-hub/emails/plain/request-approved.php.
 *
...
echo esc_html__( 'Good news — we approved your request. Any change to your order is reflected below.', 'wpmake-post-purchase-hub' ) . "\n\n";
