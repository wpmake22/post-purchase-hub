<?php
/**
 * The WC_Advanced_Shipment_Tracking name, for static analysis only.
 *
...
if ( ! class_exists( 'WC_Advanced_Shipment_Tracking' ) ) {
	/**
	 * Advanced Shipment Tracking's main class.
	 */
	class WC_Advanced_Shipment_Tracking {}
}
